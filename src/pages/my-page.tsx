      ...
      {tab === "address" && (
        <div className="space-y-3">
          {addresses.map((addr) => (
            <div
              key={addr.id}
              className="rounded-2xl border border-neutral-100 px-4 py-3"
            >
            ...
            <div className="rounded-2xl border border-[#f4c9cf] bg-[#fffafb] p-4">
              ...
              <div className="space-y-2">
                <input
                  ...
                  className="h-11 w-full rounded-xl border border-neutral-200 bg-white px-3 text-sm outline-none placeholder:text-neutral-400"
                />
                <input
                  name="name"
                  value={form.name}
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    value={form.zipcode}
                    placeholder="우편번호"
                    className="h-11 flex-1 rounded-xl border border-neutral-200 bg-white px-3 text-sm outline-none placeholder:text-neutral-400"
                  />
                  <button
                ...
                <button
                  ...
                  className="h-11 w-full rounded-xl bg-[#f48b94] text-sm font-semibold text-white transition hover:bg-[#ee7b86]"
                >
                  저장
                </button>
              </div>
